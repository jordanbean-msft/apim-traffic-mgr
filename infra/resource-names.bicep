...
output functionAppHealthProbeEndpointName string = 'health'
...
output keyVaultName string = 'kv${appName}${region1}${env}'
output functionAppKeySecretName string = 'functionAppKey'
output managedIdentityName string = 'mi-${appName}-${region1}-${env}'
